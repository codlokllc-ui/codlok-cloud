...
**Spec Version: 3.3** — Last updated: Notifications (§21) frozen. Not yet built. Eight modules now specified (seven built + Notifications spec-ready), matching the maturity Storage/Pay/Verify had before their own build phase.
