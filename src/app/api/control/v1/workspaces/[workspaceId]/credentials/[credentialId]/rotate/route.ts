...
export async function POST(req: NextRequest, { params }: { params: Promise<{ workspaceId: string; credentialId: string }> }) {
  ...
  return sendResponse(await ProductCredentials.rotateCredential(workspaceId, credentialId, auth.userId));
}
