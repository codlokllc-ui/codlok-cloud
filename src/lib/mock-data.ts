...
export function getMockModules(productId: string): ModuleStatus[] {
  return [
    ...
    },
    {
      ...
      name: 'Pay',
      configured: true,
      provider: true ? 'stripe' : null,
      status: true ? 'operational' : 'not_configured',
      recordCount: true ? 156 : 0,
      lastActivity: true ? '2026-07-13T14:30:00Z' : '—',
    },
    {
      moduleId: 'verify',
      name: 'Verify',
      configured: true,
      provider: true ? 'stripe_identity' : null,
      status: true ? 'operational' : 'not_configured',
      recordCount: true ? 342 : 0,
      lastActivity: true ? '2026-07-13T14:35:00Z' : '—',
    },
    {
